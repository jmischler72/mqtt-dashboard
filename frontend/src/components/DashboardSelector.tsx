...
export default function DashboardSelector({
    ...
    const handleRename = async () => {
        ...
        setBusy(true)
        try {
            const d = await api.put<Dashboard>(`/api/dashboards/${activeDashboardId}`, { name })
            onRename(d)
            setRenameOpen(false)
        } catch { }
        setBusy(false)
                ...
                <div className="modal modal-open">
                    <div className="modal-box max-w-sm">
                        ...
                        <div className="modal-action">
                            <button className="btn btn-sm btn-ghost" onClick={() => setCreateOpen(false)}>
                                Cancel
                            </button>
                            <button
            ...
            {renameOpen && (
                <div className="modal modal-open">
                    <div className="modal-box max-w-sm">
                        ...
                        <div className="modal-action">
                            <button className="btn btn-sm btn-ghost" onClick={() => setRenameOpen(false)}>
                                Cancel
                            </button>
                            <button
                                className="btn btn-sm btn-primary"
                ...
                <div className="modal modal-open">
                    <div className="modal-box max-w-sm">
                        ...
                        <p className="text-sm text-base-content/70 mb-4">
                            Delete <strong>{activeDashboard.name}</strong>? All panels in this dashboard will be permanently removed.
                        </p>
                        <div className="modal-action">
                            <button className="btn btn-sm btn-ghost" onClick={() => setDeleteOpen(false)}>
                                Cancel
                            </button>
                            <button
