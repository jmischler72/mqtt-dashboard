...
sqlite3 "$DB" "
  ...
  INSERT INTO dashboard_layouts (id, dashboard_id, title, panel_type, x, y, w, h, config_json, broker_id) VALUES
    ('panel-welcome', 'default', 'Welcome', 'text', 0, 0, 12, 2,
      '{\"markdown\":\"# MQTT Dashboard Demo\\nA worker publishes live sensor data every 5 seconds. **Your changes are reset every 5 hours.**\"}',
      NULL),
    ('panel-stats', 'default', 'Activity', 'stats', 0, 2, 12, 6,
      '{\"showStatTiles\":true,\"showChart\":true,\"showTopicBreakdown\":true,\"defaultRange\":60}',
      'demo-broker'),
    ('panel-sensors', 'default', 'Sensor Data', 'log', 0, 8, 6, 8,
      '{\"topics\":\"sensors/#\",\"maxMessages\":50}',
      'demo-broker'),
    ('panel-test', 'default', 'Test Messages', 'log', 6, 8, 6, 8,
      '{\"topics\":\"test/#\",\"maxMessages\":50}',
      'demo-broker');
"

echo "$(date): database reset and re-seeded"
