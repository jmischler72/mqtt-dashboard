...
- ✅ the line should collapse/expand when i click the left part of line where the arrow is instead of the whole line
- add breadcrumb in title of topic to navigate easier over the log panel
